...
def mainMenuKeyboard() -> InlineKeyboardMarkup:
    ...
    builder.button(text="Configuration", callback_data="menu:config")
...
def durationKeyboard() -> InlineKeyboardMarkup:
    builder = InlineKeyboardBuilder()
    builder.button(text="30 seconds", callback_data="duration:30")
    builder.button(text="1 minute", callback_data="duration:60")
    builder.button(text="5 minutes", callback_data="duration:300")
    builder.button(text="10 minutes", callback_data="duration:600")
    builder.button(text="Custom", callback_data="duration:custom")
...
def workersKeyboard() -> InlineKeyboardMarkup:
    builder = InlineKeyboardBuilder()
    builder.button(text="2 workers", callback_data="workers:2")
    builder.button(text="4 workers", callback_data="workers:4")
    builder.button(text="8 workers", callback_data="workers:8")
    builder.button(text="16 workers", callback_data="workers:16")
    builder.button(text="Custom", callback_data="workers:custom")
    builder.button(text="Back", callback_data="nav:duration")
    builder.adjust(2, 2, 1, 1)
    return builder.as_markup()


def proxyKeyboard(proxyFileExists: bool) -> InlineKeyboardMarkup:
    builder = InlineKeyboardBuilder()
    builder.button(text="No proxy", callback_data="proxy:none")
    if proxyFileExists:
        builder.button(text="Use proxy file", callback_data="proxy:file")
...
def confirmKeyboard() -> InlineKeyboardMarkup:
    builder = InlineKeyboardBuilder()
    builder.button(text="Start Test", callback_data="confirm:start")
...
def runningKeyboard() -> InlineKeyboardMarkup:
    ...
    builder.button(text="Refresh", callback_data="test:refresh")
    builder.adjust(2)
    return builder.as_markup()
